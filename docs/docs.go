    ...
    "paths": {
        ...
        "/auth/activate": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Alternative: JSON body with user_id and code",
                        "name": "body",
                        "in": "body",
                        "schema": {
        ...
        "/auth/login": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Email and password; optional two_factor_code",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "clinic-vet-api_internal_infrastructure_http_handlers_dtos.CreateUserRequest": {
            ...
            "properties": {
                ...
                "role": {
                    "description": "Role of the user (admin, veterinarian, customer, receptionist)\nRequired: true\nExample: customer",
                    "type": "string",
                    "enum": [
                        "admin",
                        "veterinarian",
        ...
        "clinic-vet-api_internal_infrastructure_http_handlers_dtos.CustomerSearchRequest": {
            ...
            "properties": {
                ...
                "search": {
                    "description": "Optional text search over first and last name.",
                    "type": "string"
                },
                "sort_direction": {
                    "enum": [
        ...
        "clinic-vet-api_internal_infrastructure_http_handlers_dtos.ProfileInfo": {
            ...
            "properties": {
                "bio": {
                    ...
                    "type": "string",
                    "maxLength": 500,
                    "example": "Animal lover and pet owner"
                },
                "date_of_birth": {
        ...
        "clinic-vet-api_internal_infrastructure_http_handlers_dtos.UserResponse": {
            ...
            "properties": {
                ...
                "customer_id": {
                    "description": "ID of the associated customer (for customer users)\nExample: 789",
                    "type": "integer",
                    "example": 789
                },
                "email": {
                ...
                "employee_id": {
                    "description": "ID of the associated employee (for staff users)\nExample: 456",
                    "type": "integer",
                    "example": 456
                },
                "id": {
                ...
                "status": {
                    "description": "Status of the user account (active, inactive, banned, pending)\nExample: active",
                    "type": "string",
                    "example": "active"
                },
                "two_factor_enabled": {

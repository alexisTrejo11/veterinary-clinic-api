...
type PaymentReportResponse struct {
	...
	PaymentsByMethod map[paymentDomain.PaymentMethod]PaymentSummary `json:"payments_by_method"`
	PaymentsByStatus map[paymentDomain.PaymentStatus]PaymentSummary `json:"payments_by_status"`
}

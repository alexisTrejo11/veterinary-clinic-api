...
type PaymentRepository interface {
	...
	GetByIDAndPaidFrom(ctx context.Context, id valueobject.OwnerID) (payment.Payment, error)

	ListByPaidFrom(ctx context.Context, ownerID valueobject.OwnerID, pagination page.PageInput) (page.Page[[]payment.Payment], error)

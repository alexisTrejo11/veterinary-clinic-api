...
func (o *OAuth2SecretTokenImpl) Validate(token string) (*TokenClaims, error) {
	if o.IsExpired() {
...
func (o *OAuth2SecretTokenImpl) GetType() TokenType      { return OAuth2SecretToken }

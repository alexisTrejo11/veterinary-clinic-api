...
type MedicalHistoryCommandHandlers interface {
	CreateMedicalHistory(command CreateMedHistCommand) CreateMedHistResult
	UpdateMedicalHistory(command UpdateMedHistCommand) UpdateMedHistResult
	SoftDeleteMedicalHistory(command SoftDeleteMedHistCommand) DeleteMedHistResult
	HardDeleteMedicalHistory(command HardDeleteMedHistCommand) DeleteMedHistResult
}
...
func (h *medicalHistoryCommandHandlers) CreateMedicalHistory(command CreateMedHistCommand) CreateMedHistResult {
...
func (h *medicalHistoryCommandHandlers) UpdateMedicalHistory(command UpdateMedHistCommand) UpdateMedHistResult {
...
func (h *medicalHistoryCommandHandlers) SoftDeleteMedicalHistory(command SoftDeleteMedHistCommand) DeleteMedHistResult {
	exists, err := h.repo.ExistsByID(command.CTX, command.ID)
	if err != nil {
...
func (h *medicalHistoryCommandHandlers) HardDeleteMedicalHistory(command HardDeleteMedHistCommand) DeleteMedHistResult {
	exists, err := h.repo.ExistsByID(command.CTX, command.ID)
	if err != nil {
		return *errorDeleteResult(command.ID, msgErrorProcessingData, err)
	}

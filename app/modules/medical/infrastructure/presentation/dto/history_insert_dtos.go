...
type MedicalHistoryCreate struct {
	...
	CustomerID  valueobject.CustomerID `json:"customerID" binding:"required"`
	...
	EmployeeID  valueobject.EmployeeID `json:"employeeID" binding:"required"`
}
...
type MedicalHistoryUpdate struct {
	...
	EmployeeID  *int          `json:"employeeID" binding:"omitempty,gt=0"`
	CustomerID  *int          `json:"customerID" binding:"omitempty,gt=0"`
}

...
// ApptAdminCommandController handles appointment management operations
...
type ApptAdminCommandController struct {
	commandBus cqrs.CommandBus
	validate   *validator.Validate
}

func NewApptCommandController(commandBus cqrs.CommandBus, validate *validator.Validate) *ApptAdminCommandController {
	return &ApptAdminCommandController{
...
func (controller *ApptAdminCommandController) CreateAppointment(c *gin.Context) {
...
func (controller *ApptAdminCommandController) UpdateAppointment(c *gin.Context) {
...
func (controller *ApptAdminCommandController) DeleteAppointment(c *gin.Context) {
...
func (controller *ApptAdminCommandController) RescheduleAppointment(c *gin.Context) {
...
func (controller *ApptAdminCommandController) NotAttend(c *gin.Context) {
...
func (controller *ApptAdminCommandController) ConfirmAppointment(c *gin.Context) {
	appointmentID, err := ginUtils.ParseParamToUInt(c, "id")
	if err != nil {
		response.BadRequest(c, httpError.RequestURLParamError(err, "id", c.Param("id")))
		return
...
func (controller *ApptAdminCommandController) CompleteAppointment(c *gin.Context) {
	appointmentID, err := ginUtils.ParseParamToUInt(c, "id")
	if err != nil {
		response.BadRequest(c, httpError.RequestURLParamError(err, "id", c.Param("id")))
		return

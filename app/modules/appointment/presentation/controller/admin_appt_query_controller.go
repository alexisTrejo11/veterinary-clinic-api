...
// ApptAdminQueryController handles appointment query operations
...
type ApptAdminQueryController struct {
	queryBus cqrs.QueryBus
	validate *validator.Validate
}

func NewApptQueryController(queryBus cqrs.QueryBus, validate *validator.Validate) *ApptAdminQueryController {
	return &ApptAdminQueryController{
		queryBus: queryBus,
		validate: validate,
	}
}
...
func (controller *ApptAdminQueryController) GetAppointmentByID(c *gin.Context) {
...
func (controller *ApptAdminQueryController) SearchAppointments(c *gin.Context) {
...
func (controller *ApptAdminQueryController) GetAppointmentsByDateRange(c *gin.Context) {
...
func (controller *ApptAdminQueryController) GetAppointmentsByOwner(c *gin.Context) {
...
func (controller *ApptAdminQueryController) GetAppointmentsByVet(c *gin.Context) {
	ownerID, err := ginUtils.ParseParamToUInt(c, "id")
	if err != nil {
		response.BadRequest(c, httpError.RequestURLParamError(err, "id", c.Param("id")))
		return
...
func (controller *ApptAdminQueryController) GetAppointmentsByPet(c *gin.Context) {
...
func (controller *ApptAdminQueryController) GetAppointmentStats(c *gin.Context) {

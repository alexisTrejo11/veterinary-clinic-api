...
func NewVetSearchRequestFromContext(c *gin.Context) (*VetSearchRequest, error) {
	var request VetSearchRequest
...
func (r *VetSearchRequest) processBooleanParams(c *gin.Context) {
...
// ToSpecification convierte el request a VetSearchSpecification
func (r *VetSearchRequest) ToSpecification() (*specification.VetSearchSpecification, error) {
	spec := specification.NewVetSearchSpecification()
...
func RegisterVetSearchValidations(validate *validator.Validate) error {
	// Validación personalizada para enum.VetSpecialty
	if err := validate.RegisterValidation("vet_specialty", validateVetSpecialty); err != nil {
...
func validateVetSpecialty(fl validator.FieldLevel) bool {

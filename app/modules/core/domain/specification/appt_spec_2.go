...
func (s ApptByReasonSpec) ToSQLCParams() ApptSearchParams {
	// Remove this since you don't have reason field
...
// ApptByReasonSpec methods
func (s ApptByReasonSpec) And(spec ApptSearchSpecification) ApptSearchSpecification {
	return &ApptCompositeSpec{specs: []ApptSearchSpecification{s, spec}, operator: "AND"}
}

func (s ApptByReasonSpec) Or(spec ApptSearchSpecification) ApptSearchSpecification {
	return &ApptCompositeSpec{specs: []ApptSearchSpecification{s, spec}, operator: "OR"}
}

func (s ApptByReasonSpec) WithPagination(pagination Pagination) ApptSearchSpecification {
	return &ApptCompositeSpec{specs: []ApptSearchSpecification{s}, operator: "AND", pagination: pagination}
}
...
func ApptByReason(reason enum.VisitReason) ApptSearchSpecification {
	return ApptByReasonSpec{Reason: reason}
}

...
type PaymentRepository interface {
	CreatePayment(params sqlc.CreatePaymentParams) error
	GetPaymentByID(PaymentId int32) (*sqlc.Payment, error)
	UpdatePayment(updateParams sqlc.UpdatePaymentParams) error

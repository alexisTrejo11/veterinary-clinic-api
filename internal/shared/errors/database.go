...
func DatabaseError(operation, tableName, dbType string, originalErr error) error {
	log.Error(
...
func DBNotFoundError(paramName, paramValue, operation, tableName, dbType string) error {

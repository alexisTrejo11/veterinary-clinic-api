...
func NewCustomerError(ctx context.Context, code, message, operation string, details map[string]string) error {
	...
	return &CustomerError{
		BaseApplicationError: &errors.BaseApplicationError{
			Code:       code,
			Type:       "domain",
			Message:    message,
...
func PetAlreadyExistsError(ctx context.Context, petID pets.PetID, operation string) error {
	return NewCustomerError(ctx,
		"CUSTOMER_PET_EXISTS",
...
func PetNotFoundError(ctx context.Context, petID pets.PetID, operation string) error {
	return NewCustomerError(ctx,
...
func UserAlreadyAssociatedError(ctx context.Context, userID uint, operation string) error {
	return NewCustomerError(ctx,

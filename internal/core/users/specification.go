...
func (s *UserSpecification) WithEmails(emails ...Email) *UserSpecification {
	s.Emails = emails
	return s
}

func (s *UserSpecification) WithRoles(roles ...UserRole) *UserSpecification {
	s.Roles = roles
	return s
}

func (s *UserSpecification) WithStatuses(statuses ...UserStatus) *UserSpecification {
	s.Statuses = statuses
	return s
}
...
func (s *UserSpecification) WithPagination(pageNumber, pageSize int, orderBy, sortDir string) *UserSpecification {
